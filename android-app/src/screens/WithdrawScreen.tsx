...
const styles = StyleSheet.create({
  ...
  walletCard: { backgroundColor: 'rgba(255,255,255,0.96)', borderColor: '#CFE3F3', alignItems: 'center', paddingVertical: 22 },
  walletLabel: { color: colors.textSecondary, fontSize: 13 },
  walletBalance: { color: colors.text, fontSize: 34, fontWeight: '800', marginTop: 6 },
