...
const styles = StyleSheet.create({
  ...
  walletCard: { backgroundColor: colors.green, borderColor: colors.green, alignItems: 'center', paddingVertical: 22 },
  walletLabel: { color: '#dcfce7', fontSize: 13 },
  walletBalance: { color: '#ffffff', fontSize: 34, fontWeight: '800', marginTop: 6 },
  walletMetaRow: { flexDirection: 'row', gap: 14, marginTop: 12 },
  walletMeta: { color: '#dcfce7', fontSize: 12 },
