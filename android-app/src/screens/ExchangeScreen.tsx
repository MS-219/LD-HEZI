...
const styles = StyleSheet.create({
  ...
  headCard: { backgroundColor: colors.green, borderColor: colors.green },
  headRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  headLabel: { color: '#dcfce7', fontSize: 13 },
  ...
  productImageFallback: { alignItems: 'center', justifyContent: 'center', backgroundColor: '#eef2ff' },
