...
const styles = StyleSheet.create({
  ...
  overviewCard: { backgroundColor: 'rgba(255,255,255,0.96)', borderColor: '#CFE3F3' },
  overviewMain: { alignItems: 'center', paddingVertical: 8 },
  overviewLabel: { color: colors.textSecondary, fontSize: 13 },
  overviewTotal: { color: colors.text, fontSize: 32, fontWeight: '800', marginTop: 6 },
  overviewRow: { flexDirection: 'row', marginTop: 12 },
  overviewItem: { flex: 1, alignItems: 'center' },
  overviewValue: { color: colors.text, fontSize: 15, fontWeight: '700' },
  overviewMeta: { color: colors.muted, fontSize: 12, marginTop: 3 },
