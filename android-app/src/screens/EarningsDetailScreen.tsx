...
const styles = StyleSheet.create({
  ...
  overviewCard: { backgroundColor: colors.primary, borderColor: colors.primary },
  overviewMain: { alignItems: 'center', paddingVertical: 8 },
  overviewLabel: { color: '#e0e7ff', fontSize: 13 },
  ...
  overviewMeta: { color: '#c7d2fe', fontSize: 12, marginTop: 3 },
