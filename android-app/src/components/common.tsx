...
const styles = StyleSheet.create({
  ...
  navBackText: { fontSize: 30, color: '#ffffff', marginTop: -4 },
  navTitle: { flex: 1, textAlign: 'center', fontSize: 16, fontWeight: '700', color: '#ffffff', letterSpacing: 1 },
  ...
  segmentItemOn: { borderBottomColor: colors.cyan, backgroundColor: '#f4faff' },
  segmentText: { color: colors.textSecondary, fontWeight: '600', fontSize: 13 },
  segmentTextOn: { color: colors.navy, fontWeight: '700' },
  badge: {
    borderRadius: 999,
