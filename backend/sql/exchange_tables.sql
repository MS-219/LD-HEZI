...
CREATE TABLE IF NOT EXISTS exchange_product (
    ...
    base_price DECIMAL(10,2) NOT NULL COMMENT '基础价格(U)',
    price_level1 DECIMAL(10,2) COMMENT '会员价(U)',
    price_level2 DECIMAL(10,2) COMMENT '社区价(U)',
    price_level3 DECIMAL(10,2) COMMENT '县级价(U)',
    price_level4 DECIMAL(10,2) COMMENT '市级价(U)',
    price_level5 DECIMAL(10,2) COMMENT '联创价(U)',
...
CREATE TABLE IF NOT EXISTS exchange_order (
    ...
    unit_price DECIMAL(10,2) NOT NULL COMMENT '单价(U)',
    total_price DECIMAL(10,2) NOT NULL COMMENT '总价(U)',
    ...
    inviter_profit DECIMAL(10,2) DEFAULT 0 COMMENT '邀请人分润金额(U)',
    create_time DATETIME DEFAULT CURRENT_TIMESTAMP,
    update_time DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    INDEX idx_user_id (user_id),
