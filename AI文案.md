# [Google Gemini 对话格式（Generate Content）](https://api.lingyaai.cn/doc/#/coding/gemini?id=google-gemini-%e5%af%b9%e8%af%9d%e6%a0%bc%e5%bc%8f%ef%bc%88generate-content%ef%bc%89)

!!! info "官方文档" [Google Gemini Generating content API](https://ai.google.dev/api/generate-content)

## [📝 简介](https://api.lingyaai.cn/doc/#/coding/gemini?id=%f0%9f%93%9d-%e7%ae%80%e4%bb%8b)

Google Gemini API 支持使用图片、音频、代码、工具等生成内容。给定输入 GenerateContentRequest 生成模型响应。支持文本生成、视觉理解、音频处理、长上下文、代码执行、JSON 模式、函数调用等多种功能。

## [💡 请求示例](https://api.lingyaai.cn/doc/#/coding/gemini?id=%f0%9f%92%a1-%e8%af%b7%e6%b1%82%e7%a4%ba%e4%be%8b)

### [基础文本对话 ✅](https://api.lingyaai.cn/doc/#/coding/gemini?id=%e5%9f%ba%e7%a1%80%e6%96%87%e6%9c%ac%e5%af%b9%e8%af%9d-%e2%9c%85)

```
curl "https://api.lingyaai.cn/v1beta/models/gemini-2.0-flash:generateContent?key=$API_KEY" \
    ...
    -d '{
      "contents": [{
       ...
       }' 2> /dev/nullCopy to clipboardErrorCopied
```

### [图像分析对话 ✅](https://api.lingyaai.cn/doc/#/coding/gemini?id=%e5%9b%be%e5%83%8f%e5%88%86%e6%9e%90%e5%af%b9%e8%af%9d-%e2%9c%85)
...
curl "https://api.lingyaai.cn/v1beta/models/gemini-2.0-flash:generateContent?key=$API_KEY" \
    -H 'Content-Type: application/json' \
    -X POST \
    -d "@$TEMP_JSON" 2> /dev/nullCopy to clipboardErrorCopied
```

### [函数调用 ✅](https://api.lingyaai.cn/doc/#/coding/gemini?id=%e5%87%bd%e6%95%b0%e8%b0%83%e7%94%a8-%e2%9c%85)
...
') 2>/dev/null |sed -n '/"content"/,/"finishReason"/p'Copy to clipboardErrorCopied
```

### [JSON 模式响应 ✅](https://api.lingyaai.cn/doc/#/coding/gemini?id=json-%e6%a8%a1%e5%bc%8f%e5%93%8d%e5%ba%94-%e2%9c%85)
...
}' 2> /dev/null | headCopy to clipboardErrorCopied
```

### [音频处理 🟡](https://api.lingyaai.cn/doc/#/coding/gemini?id=%e9%9f%b3%e9%a2%91%e5%a4%84%e7%90%86-%f0%9f%9f%a1)
...
curl "https://api.lingyaai.cn/v1beta/models/gemini-2.0-flash:generateContent?key=$API_KEY" \
  ...
  }' 2> /dev/null | jq ".candidates[].content.parts[].text"Copy to clipboardErrorCopied
```

### [视频处理 🟡](https://api.lingyaai.cn/doc/#/coding/gemini?id=%e8%a7%86%e9%a2%91%e5%a4%84%e7%90%86-%f0%9f%9f%a1)
...
### [PDF处理 🟡](https://api.lingyaai.cn/doc/#/coding/gemini?id=pdf%e5%a4%84%e7%90%86-%f0%9f%9f%a1)
...
### [聊天对话 ✅](https://api.lingyaai.cn/doc/#/coding/gemini?id=%e8%81%8a%e5%a4%a9%e5%af%b9%e8%af%9d-%e2%9c%85)
...
curl https://api.lingyaai.cn/v1beta/models/gemini-2.0-flash:generateContent?key=$API_KEY \
    ...
    }' 2> /dev/null | grep "text"Copy to clipboardErrorCopied
```

### [流式响应 ✅](https://api.lingyaai.cn/doc/#/coding/gemini?id=%e6%b5%81%e5%bc%8f%e5%93%8d%e5%ba%94-%e2%9c%85)

```
curl "https://api.lingyaai.cn/v1beta/models/gemini-2.0-flash:streamGenerateContent?alt=sse&key=$API_KEY" \
    -H 'Content-Type: application/json' \
    --no-buffer \
    -d '{
      "contents": [{
...
### [代码执行 ✅](https://api.lingyaai.cn/doc/#/coding/gemini?id=%e4%bb%a3%e7%a0%81%e6%89%a7%e8%a1%8c-%e2%9c%85)
...
### [生成配置 ✅](https://api.lingyaai.cn/doc/#/coding/gemini?id=%e7%94%9f%e6%88%90%e9%85%8d%e7%bd%ae-%e2%9c%85)
...
### [安全设置 ✅](https://api.lingyaai.cn/doc/#/coding/gemini?id=%e5%ae%89%e5%85%a8%e8%ae%be%e7%bd%ae-%e2%9c%85)
...
curl "https://api.lingyaai.cn/v1beta/models/gemini-2.0-flash:generateContent?key=$API_KEY" \
    -H 'Content-Type: application/json' \
    -X POST \
    -d @request.json 2> /dev/nullCopy to clipboardErrorCopied
```

### [系统指令 ✅](https://api.lingyaai.cn/doc/#/coding/gemini?id=%e7%b3%bb%e7%bb%9f%e6%8c%87%e4%bb%a4-%e2%9c%85)
...
-d '{ "system_instruction": {
    ...
    "contents": {
      "parts": {
        "text": "Hello there"}}}'Copy to clipboardErrorCopied
```

## [📮 请求](https://api.lingyaai.cn/doc/#/coding/gemini?id=%f0%9f%93%ae-%e8%af%b7%e6%b1%82)

### [端点](https://api.lingyaai.cn/doc/#/coding/gemini?id=%e7%ab%af%e7%82%b9)

#### [生成内容](https://api.lingyaai.cn/doc/#/coding/gemini?id=%e7%94%9f%e6%88%90%e5%86%85%e5%ae%b9)

```
POST https://api.lingyaai.cn/v1beta/{model=models/*}:generateContentCopy to clipboardErrorCopied
```

#### [流式生成内容](https://api.lingyaai.cn/doc/#/coding/gemini?id=%e6%b5%81%e5%bc%8f%e7%94%9f%e6%88%90%e5%86%85%e5%ae%b9)

```
POST https://api.lingyaai.cn/v1beta/{model=models/*}:streamGenerateContentCopy to clipboardErrorCopied
```

### [鉴权方法](https://api.lingyaai.cn/doc/#/coding/gemini?id=%e9%89%b4%e6%9d%83%e6%96%b9%e6%b3%95)

在请求URL参数中包含API密钥：

```
?key=$API_KEYCopy to clipboardErrorCopied
```

其中 `$API_KEY` 是您的 Google AI API 密钥。

### [路径参数](https://api.lingyaai.cn/doc/#/coding/gemini?id=%e8%b7%af%e5%be%84%e5%8f%82%e6%95%b0)

#### [`model`](https://api.lingyaai.cn/doc/#/coding/gemini?id=model)
...
### [请求体参数](https://api.lingyaai.cn/doc/#/coding/gemini?id=%e8%af%b7%e6%b1%82%e4%bd%93%e5%8f%82%e6%95%b0)

#### [`contents`](https://api.lingyaai.cn/doc/#/coding/gemini?id=contents)
...
#### [`tools`](https://api.lingyaai.cn/doc/#/coding/gemini?id=tools)
...
#### [`toolConfig`](https://api.lingyaai.cn/doc/#/coding/gemini?id=toolconfig)
...
#### [`safetySettings`](https://api.lingyaai.cn/doc/#/coding/gemini?id=safetysettings)
...
#### [`systemInstruction`](https://api.lingyaai.cn/doc/#/coding/gemini?id=systeminstruction)
...
#### [`generationConfig`](https://api.lingyaai.cn/doc/#/coding/gemini?id=generationconfig)
...
#### [`cachedContent`](https://api.lingyaai.cn/doc/#/coding/gemini?id=cachedcontent)
...
## [📥 响应](https://api.lingyaai.cn/doc/#/coding/gemini?id=%f0%9f%93%a5-%e5%93%8d%e5%ba%94)

### [GenerateContentResponse](https://api.lingyaai.cn/doc/#/coding/gemini?id=generatecontentresponse)

支持多个候选回答的模型的回答。系统会针对提示以及每个候选项报告安全分级和内容过滤。

#### [`candidates`](https://api.lingyaai.cn/doc/#/coding/gemini?id=candidates)
...
#### [`promptFeedback`](https://api.lingyaai.cn/doc/#/coding/gemini?id=promptfeedback)
...
#### [`usageMetadata`](https://api.lingyaai.cn/doc/#/coding/gemini?id=usagemetadata)
...
#### [`modelVersion`](https://api.lingyaai.cn/doc/#/coding/gemini?id=modelversion)

* 类型：字符串
* 说明：用于生成回答的模型版本

#### [`responseId`](https://api.lingyaai.cn/doc/#/coding/gemini?id=responseid)

* 类型：字符串
* 说明：用于标识每个响应的ID

#### [完整响应示例](https://api.lingyaai.cn/doc/#/coding/gemini?id=%e5%ae%8c%e6%95%b4%e5%93%8d%e5%ba%94%e7%a4%ba%e4%be%8b)
...
## [🔧 高级功能](https://api.lingyaai.cn/doc/#/coding/gemini?id=%f0%9f%94%a7-%e9%ab%98%e7%ba%a7%e5%8a%9f%e8%83%bd)

### [安全评级](https://api.lingyaai.cn/doc/#/coding/gemini?id=%e5%ae%89%e5%85%a8%e8%af%84%e7%ba%a7)
...
### [引用元数据](https://api.lingyaai.cn/doc/#/coding/gemini?id=%e5%bc%95%e7%94%a8%e5%85%83%e6%95%b0%e6%8d%ae)
...
### [代码执行](https://api.lingyaai.cn/doc/#/coding/gemini?id=%e4%bb%a3%e7%a0%81%e6%89%a7%e8%a1%8c)
...
### [接地功能 (Grounding)](https://api.lingyaai.cn/doc/#/coding/gemini?id=%e6%8e%a5%e5%9c%b0%e5%8a%9f%e8%83%bd-grounding)
...
### [多模态处理](https://api.lingyaai.cn/doc/#/coding/gemini?id=%e5%a4%9a%e6%a8%a1%e6%80%81%e5%a4%84%e7%90%86)
...
### [思考功能](https://api.lingyaai.cn/doc/#/coding/gemini?id=%e6%80%9d%e8%80%83%e5%8a%9f%e8%83%bd)
...
### [语音生成](https://api.lingyaai.cn/doc/#/coding/gemini?id=%e8%af%ad%e9%9f%b3%e7%94%9f%e6%88%90)
...
### [Logprobs 结果](https://api.lingyaai.cn/doc/#/coding/gemini?id=logprobs-%e7%bb%93%e6%9e%9c)
...
### [URL检索功能](https://api.lingyaai.cn/doc/#/coding/gemini?id=url%e6%a3%80%e7%b4%a2%e5%8a%9f%e8%83%bd)
...
### [完整安全类别](https://api.lingyaai.cn/doc/#/coding/gemini?id=%e5%ae%8c%e6%95%b4%e5%ae%89%e5%85%a8%e7%b1%bb%e5%88%ab)
...
## [🔍 错误处理](https://api.lingyaai.cn/doc/#/coding/gemini?id=%f0%9f%94%8d-%e9%94%99%e8%af%af%e5%a4%84%e7%90%86)

### [常见错误码](https://api.lingyaai.cn/doc/#/coding/gemini?id=%e5%b8%b8%e8%a7%81%e9%94%99%e8%af%af%e7%a0%81)
...
### [详细错误码说明](https://api.lingyaai.cn/doc/#/coding/gemini?id=%e8%af%a6%e7%bb%86%e9%94%99%e8%af%af%e7%a0%81%e8%af%b4%e6%98%8e)
...
### [错误响应示例](https://api.lingyaai.cn/doc/#/coding/gemini?id=%e9%94%99%e8%af%af%e5%93%8d%e5%ba%94%e7%a4%ba%e4%be%8b)
